    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-md-12 col-12">
                <a href="/" class="text-decoration-none d-xl-none d-md-none d-block"><img src="/dist/img/logoBind.png" width="80%" alt="Logotipo"></a>
                <a href="/" class="text-decoration-none d-xl-block d-md-none d-none"><img src="/dist/img/logoBind.png" width="20%" alt="Logotipo"></a>
                <a href="/" class="text-decoration-none d-xl-none d-md-block d-none"><img src="/dist/img/logoBind.png" width="35%" alt="Logotipo"></a>
            </div>

            <!-- Mobile -->
            <div class="col-xl-6 col-md-12 col-12 mt-3 d-xl-none d-md-none d-block">
                <ul class="col-lg-auto nav text-small justify-content-center">
                    <li>
                        <a href="/" class="nav-link text-white text-center d-flex">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-speedometer2" viewBox="0 0 16 16">
                            ...
                            <span class="mt-1" style="font-size: x-small;">Dashboard</span>
                        </a>
                    </li>
                    <li>
                        <a href="/productos" class="nav-link text-white text-center d-flex">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-box-seam" viewBox="0 0 16 16">
                                <path d="M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5l2.404.961L10.404 2l-2.218-.887zm3.564 1.426L5.596 5 8 5.961 14.154 3.5l-2.404-.961zm3.25 1.7-6.5 2.6v7.922l6.5-2.6V4.24zM7.5 14.762V6.838L1 4.239v7.923l6.5 2.6zM7.443.184a1.5 1.5 0 0 1 1.114 0l7.129 2.852A.5.5 0 0 1 16 3.5v8.662a1 1 0 0 1-.629.928l-7.185 2.874a.5.5 0 0 1-.372 0L.63 13.09a1 1 0 0 1-.63-.928V3.5a.5.5 0 0 1 .314-.464L7.443.184z"/>
                            </svg>
                            <span class="mt-1" style="font-size: x-small;">Productos</span>
                        </a>
                    </li>
                    <li>
                        <a href="/eventos" class="nav-link text-white text-center d-flex">
                            ...
                            <span class="mt-1" style="font-size: x-small;">Eventos</span>
                        </a>
                    </li>
                    <li>
                        <a href="/usuarios" class="nav-link text-white text-center d-flex">
                            ...
                            <span class="mt-1" style="font-size: x-small;">Usuarios</span>
                        </a>
                    </li>
                    <li>
                        <a href="/logout" class="nav-link text-white text-center d-flex">
                            ...
                            <span class="mt-1" style="font-size: x-small;">Cerrar sesión</span>
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <ul class="col-lg-auto nav text-small justify-content-end">
                    ...
                    <li>
                        <a href="/logout" class="nav-link text-white text-center d-flex">
                            ...
                            <span class="mt-1">Cerrar sesión</span>
                        </a>
                    </li>
                </ul>
            </div>
