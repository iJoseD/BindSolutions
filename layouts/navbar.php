<?php session_start(); $fullName = $_SESSION['fullName']; ?>
        ...
        <div class="container">
            <div class="align-items-center d-flex">
                ...
                <ul class="col-lg-auto nav text-small">
                    ...
                    <li>
                        <a href="/productos" class="nav-link text-white text-center">
                    ...
                    <li>
                        <a href="/eventos" class="nav-link text-white text-center">
                    ...
                    <li>
                        <a href="/usuarios" class="nav-link text-white text-center">
