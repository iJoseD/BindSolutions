<header class="container-fluid bg-dark p-3">
    <div class="container">
        <!-- Mobile -->
        <div class="row d-xl-none d-md-none d-block text-center">
            <div class="col-xl-6 col-md-12 col-12 text-center">
                <a href="/" class="text-decoration-none"><img src="/dist/img/logoBind.png" width="40%" alt="Logotipo"></a>
            </div>
            
            <div class="col-xl-6 col-md-12 col-12 mt-3">
