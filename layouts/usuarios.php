...
<section class="container mb-5">
    <div class="row mt-5">
        <div class="col-xl-3 col-md-6 col-6">
            <button type="button" class="btn bg-bind-1 fw-bold text-uppercase text-white" data-bs-toggle="modal" data-bs-target="#crearUsuario">Crear nuevo usuario</button>
        </div>
    </div>
    ...
    <div class="row mt-5">
        ...
        <div class="col-12">
            <table id="usuarios-table1" class="display responsive nowrap">
                ...
                <tbody>
                    <?php
                        $sql = "SELECT u.fullName, u.user, u.password, u.rol AS 'idRol', r.rol, u.idEvento, u.idPuntoVenta, e.nombre, pv.nombre AS 'nombrePV', u.lastLogin
                        FROM usuarios u
    ...
    <div class="row mt-5">
        ...
        <div class="col-12">
            <table id="usuarios-table2" class="display responsive nowrap">
                <thead>
                    <tr>
                        <th>Nombre</th>
                        <th>Rol</th>
