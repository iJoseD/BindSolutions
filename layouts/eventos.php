                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            $html = '<tr>';
                                ...
                                $html .= '<th>
                                    <button type="button" class="btn btn-success configurarEvento" data-linkSocio="'. $row['linkSocio'] .'">
                ...
                <div class="formulario">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            ...
                            <input type="text" name="linkSocio" id="linkSocio" class="form-control" value="<?php echo $code; ?>" readonly>
                        </div>
                    </div>
                </div>
